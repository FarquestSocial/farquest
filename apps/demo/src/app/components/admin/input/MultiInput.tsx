...
export const MultiInput: FC<IMultiInput> = forwardRef<HTMLInputElement, IMultiInput>(function MultiInput(
	{ className, id, input: Input, value, onChange, size = "default", delimiter = " ", label },
	ref
) {
