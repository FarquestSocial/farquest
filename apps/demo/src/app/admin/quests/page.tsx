...
// 	const [questToEdit, setQuestToEdit] = useState<any | undefined>(
// 		undefined,
// 	);
...
export default function AdminPage() {
  const { quests, mutate } = useQuests();
  const { isOpenQuestModal, closeQuestModal, openQuestModal, type } =
    useAdminContext();
  const [questToEdit, setQuestToEdit] = useState<any | undefined>(undefined);
  ...
  console.log("isOpenQuestModal", isOpenQuestModal);
  return (
    <>
