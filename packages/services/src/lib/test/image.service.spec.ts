...
describe('ImageService', () => {
    it('should return a similarity score close to 1 for very similar images', async () => {
        ...
        const url1 = 'https://images.ctfassets.net/q5ulk4bp65r7/1bCAEs75IaQY3G88OtkU9y/c88ff7264b91574f0ad7fea9fd699ddc/image1.png';
        const url2 = 'https://images.ctfassets.net/q5ulk4bp65r7/1bCAEs75IaQY3G88OtkU9y/c88ff7264b91574f0ad7fea9fd699ddc/image1.png';
    ...
    it('should return a lower similarity score for dissimilar images', async () => {
        ...
        const url1 = 'https://images.ctfassets.net/q5ulk4bp65r7/1bCAEs75IaQY3G88OtkU9y/c88ff7264b91574f0ad7fea9fd699ddc/image1.png';
        const url2 = 'https://blockworks-co.imgix.net/wp-content/uploads/2024/02/Farcaster-X.jpg';
    ...
    it('should handle errors gracefully', async () => {
        ...
        await expect(imageService.compareImages(url1, url2)).rejects.toThrow('Failed to fetch image');
    });
});
